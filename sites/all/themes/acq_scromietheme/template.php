 ...
 */
function acq_scromietheme_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq_scromietheme_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq_scromietheme_html_head_alter(&$head_elements) {
...
function acq_scromietheme_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq_scromietheme_get_layout();
 ...
 */
function acq_scromietheme_preprocess_block(&$vars) {
 ...
 */
function _acq_scromietheme_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq_scromietheme_get_layout() {
  $layout_patterns = _acq_scromietheme_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function acq_scromietheme_node_view_alter(&$build) {
...
function acq_scromietheme_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq_scromietheme_preprocess_media_gallery_license(&$vars) {
